#ifndef ORCHARD__ALLOCATORS_HPP
#define ORCHARD__ALLOCATORS_HPP
...
class BumpAllocator
{
  ...
  public:
    ...
    void *allocate(size_t sz, unsigned align)
    {
        ...
        ORCH_ASSERT(result >= allocBottom_ && result <= allocTop_);
        allocTop_ = result;
        return result;
    }
...
class STLPoolAllocator
{
  ...
  public:
    ...
    pointer allocate(size_type n, void *hint = nullptr)
    {
        ORCH_ASSERT(alignof(T) <= PoolAllocator::BasicAlignment);
